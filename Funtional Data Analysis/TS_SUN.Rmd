...
FtsObjectPlot3(covid_fts, country, days, nc, FALSE, 'arima', 3, 5)
...
FtsObjectPlot2(covid_fts, country, days, nc)
FtsObjectPlot3(covid_fts, country, days, nc, FALSE, 'arima', 3, 3)
...
FtsObjectPlot1(covid_fts, country, days, 0.95, 1.05)
FtsObjectPlot2(covid_fts, country, days, nc)
FtsObjectPlot3(covid_fts, country, days, nc, FALSE, 'ets', 3, 10)
```
...
FtsObjectPlot1(covid_fts, country, days, 0.95, 1.05)
FtsObjectPlot2(covid_fts, country, days, nc)
china_mae_30 <- FtsObjectPlot3(covid_fts, country, days, nc, FALSE, 'ets', 3, 5)
...
FtsObjectPlot1(covid_fts, country, days, 0.95, 1.15)
FtsObjectPlot2(covid_fts, country, days, nc)
korea_mae_30 <- FtsObjectPlot3(covid_fts, country, days, nc, FALSE, 'arima', 3, 5)
...
# MSE 비교
df_30 <- data.frame(country = c('China', 'US', 'Korea', 'Australia'),
           stationary = c('FALSE', 'FALSE', 'FALSE', 'FALSE'),
           number_of_PC = c(3, 2, 3, 4),
           lambda = c(5, 5, 5, 5),
